player_name_1 = localStorage.getItem("player_value1")
player_name_2 = localStorage.getItem("player_value2")

question_turn = localStorage.getItem(player_name_1);
answer_turn= localStorage.getItem(player_name_2);
player_1_score = 0;
player_2_score = 0;
